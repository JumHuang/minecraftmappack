package com.jumhuang.minecraftmappack.base;
...
public class BaseActivity extends AppCompatActivity
{
	...
	//压缩
	public static String Zip(String input, String output, boolean usepassword, String password)
	{
		String info=null;
		try
		{
			...
			zipFile.createZipFileFromFolder(input, parameters, true, 10485760);
			info = "压缩成功！";
		}
	...
	//解压
	public static String UnZip(String input, String output, String password)
	{
		String info=null;
		try
		{
